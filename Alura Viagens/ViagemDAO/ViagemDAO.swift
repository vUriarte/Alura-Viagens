...
class ViagemDAO: NSObject {
    ...
    func retornaTodasAsViagens() -> Array<Viagem> {
        ...
        let paraiba = Viagem(titulo: "Paraíba", quantidadeDeDias: "3", preco: "1.350,00", caminhoDaImagem: "img4.jpg")
        let fortaleza = Viagem(titulo: "Fortaleza", quantidadeDeDias: "4", preco: "3.120,00", caminhoDaImagem: "img5.jpg")
        let listaViagem: Array<Viagem> = [ceara, rioDeJaneiro, interiorSaoPaulo, paraiba, fortaleza]
